          ...
          @if (sv.is_paid) {
            ...
            <span class="flex items-center gap-1 text-[11px] bg-card-strong text-secondary rounded-full overflow-hidden">
              ...
              <button (click)="pay.emit({ expense, split: sv })"
                class="px-3 py-0.5 text-[11px] font-semibold bg-purple-500/15 text-(--badge-purple) hover:bg-purple-500/25 hover:text-purple-200 transition-all cursor-pointer whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-400/60 focus-visible:ring-inset">
                Pagar
              </button>
            </span>
          } @else {
